...
namespace OrderProcessingApp.Data.Repository
{
    public class ProductRepository : IProductRepository
    {
        ...
        // not calling repo for time constraints, just hardcoding the response from repository for other type of products
        public string ProcessProductAndCreateDuplicatePackingSlip(int productId)
        {
            ChangeStatusToProcessed(productId);
            return "Duplicate packing slip for the royalty department generated and comission has been added for Agent.";
        }

        public string ProcessProductAndGeneratePackingSlip(int productId)
        {
            ChangeStatusToProcessed(productId);
            return "Generated a packing slip for shipping and comission has been added for agent.";
        }
